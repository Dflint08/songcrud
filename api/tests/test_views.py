...
class UserRegisterListTests(APITestCase):
    ...
    def test_user_registration(self):
        user_data = {
            ...
            'first_name':'Foo',
            'last_name':'Bar',
            'password':secrets.token_urlsafe(10), #create random stre
        }
    ...
    def test_any_user_can_view_user_details(self):
        user_details_endpoint = reverse('api:user-detail', kwargs={"pk":self.pk})
        ...
        # Other authentificated users can view details
